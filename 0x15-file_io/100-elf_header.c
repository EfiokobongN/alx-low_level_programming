...
/**
 * printdata - prints organization data information
 * from the elf header
 *
 * @head: header info
 *
...
/**
 * printversion - prints elf header version info 
 *
 * @head: header info
 *
 * Return: void
...
/**
 * printabi - prints header information abi version
 *
 * @head: header info
 *
 * Return: void
...
/**
 * printtype - prints header info elf filetype
 *
 * @head: header info
 *
 * Return: void
...
/**
 * printentry - prints header executable entry address of
 *
 * @head: header info
 *
 * Return: void
...
/**
 * main - parses elf file header file
 *
 * @ac: args number
 * @av: strings arugment
 *
 ...
 * 2 if file open failure
 * 3 if read failure
 * 4 if failure to read enough bytes for 32 bit file
